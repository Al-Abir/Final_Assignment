             ...
             <Layout>
                 ...
                 <div className="min-h-screen flex items-center bg-[#4e4e4c]">
                    <div className="flex-1 max-w-7xl mx-auto">
                        ...
                        <li className="bg-[#1D1C22] row-start-1 row-span-3 col-start-1 col-span-6 md:row-start-1 md:row-span-3 md:col-start-1 md:col-span-6 lg:row-start-1 lg:row-span-5 lg:col-start-1 lg:col-span-2 rounded-lg shadow-xl"><div className="h-24">
                            <BioData></BioData>
                            </div></li>
